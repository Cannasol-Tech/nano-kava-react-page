const themes = {
  dark: {
    ...
    bgCard: 'bg-gradient-to-br from-slate-800/60 to-slate-900/60',
  ...
  light: {
    bg: 'bg-white',
    bgSecondary: 'bg-slate-50/50',
    bgCard: 'bg-white/60',
    bgCardSolid: 'bg-white/65',
    bgCardAlt: 'bg-white/55',
    bgCardStats: 'bg-white/60',
    bgNav: 'bg-white/95',
