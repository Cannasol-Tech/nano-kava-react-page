...
=======
            className={`max-w-3xl mx-auto mb-10 ${!isDark ? 'bg-white/60 rounded-3xl px-8 py-10 md:px-12 md:py-12 border border-emerald-500/20 shadow-lg shadow-slate-200/30 overflow-hidden relative' : ''}`}
>>>>>>> Stashed changes
          >
            ...
            <motion.h1
              ...
              className="relative text-6xl md:text-8xl lg:text-9xl font-black mb-6 leading-[1.1] tracking-tighter"
            >
...
=======
              <div className={`relative ${theme.bgCardSolid} ${theme.shadowXl} rounded-3xl p-8 md:p-10 border ${theme.borderCard}`}>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            >
              ...
              <div className={`relative ${theme.bgCardAlt} ${theme.shadowCard} rounded-2xl p-8 border ${theme.borderCard} h-full`}>
