 ...
 *
 * @description:
 *     Dependency-free emoji popover for the Bula composer: a curated grid of beverage,
...
export default function EmojiPicker({ onSelect, onDismiss }) {
  ...
  return (
    <div
      ...
      role="group"
      aria-label="Emoji"
      className={`bula-emoji-pop absolute bottom-full left-0 mb-2 w-64 rounded-xl border p-2 ${theme.bgCardStats} ${theme.borderCard} ${theme.shadowXl}`}
    >
